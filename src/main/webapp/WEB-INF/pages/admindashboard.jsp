...
<jsp:include page="header.jsp" />
  ...
  <div class="admin-header">
    ...
    <img src="${pageContext.request.contextPath}/resources/images/system/Redd.png" alt="Admin Profile" class="admin-pfp">
  </div>
  ...
  <div class="dashboard-buttons">
    <a href="#" class="btn"><i class="fas fa-plus"></i> Add Product</a>
    <a href="#" class="btn"><i class="fas fa-box"></i> View Orders</a>
  </div>
