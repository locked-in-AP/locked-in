            ...
            <div class="cart-items">
                <div class="cart-item card">
                    <div class="item-details">
                        <img src="${pageContext.request.contextPath}/resources/images/system/sample.png"  class="product-image" alt="Vibes Socks 211">
                ...
                <div class="cart-item card">
                    <div class="item-details">
                        <img src="https://via.placeholder.com/100" class="product-image" alt="Utitma Atom 520 Pro">
                        <div class="product-info">
                            <div class="product-header">
