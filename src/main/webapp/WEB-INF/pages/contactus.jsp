...
<body>
    ...
    <div class="container">
        ...
        <p>We'd love to hear from you! Please feel free to reach out with any questions, 
        feedback, or suggestions. Use the form below or contact us directly using the 
