...
<!-- Top Bar -->
<div class="top-bar">
	<a href="${pageContext.request.contextPath}/login" class="top-bar-item">Login
		In</a> <a href="${pageContext.request.contextPath}/aboutus"
		class="top-bar-item">About Us</a> <a
		href="${pageContext.request.contextPath}/contactus"
		class="top-bar-item">Contact Us</a>
</div>
