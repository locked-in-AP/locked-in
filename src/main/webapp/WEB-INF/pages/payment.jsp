		...
		<div class="cart-grid">
			<div class="cart-items">
				<div class="cart-item card">
					<div class="item-details">
						<img
							src="${pageContext.request.contextPath}/resources/images/system/person1.png"
				...
				<div class="cart-item card">
					<div class="item-details">
						<img
							src="${pageContext.request.contextPath}/resources/images/system/person2.png"
							class="product-image" alt="Utitma Atom 520 Pro">
						<div class="product-info">
							<div class="product-header">
			...
			<div class="order-summary card">
				...
				<div class="summary-details">
					...
					<div class="summary-row">
						<span>VAT (<span id="totalItems">2</span>)
						</span> <span id="vat">Calculate VAT</span>


					</div>

					<div class="summary-row">
						<span>Delivery Charge (<span id="totalItems">2</span>)
						</span> <span id="delivery-charge">Calculate Delivery</span>
				...
				<div class="payment-option-container">
					<div class="pay-option" id="credit-card-option">Pay via
					...
					<div class="card-details" id="card-details">
						...
						<div class="form-row">
							<div class="form-group">
								<label for="expiry-date">Expiration date (MM / YY)</label> <input
									type="text" id="expiry-date" placeholder="MM / YY">
							</div>
							<div class="form-group">
						...
						<div class="form-group">
							<label for="card-name">Name on card</label> <input type="text"
								id="card-name" placeholder="Name on card">
						</div>
					</div>
				</div>
